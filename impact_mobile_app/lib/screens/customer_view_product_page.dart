import 'package:farmer_app/screens/customer_order_product_page.dart';
import 'package:flutter/material.dart';
import 'dart:convert';
import 'package:http/http.dart' as http;

class CustomerViewProductPage extends StatefulWidget {
  @override
  _CustomerViewProductPageState createState() => _CustomerViewProductPageState();
}

class _CustomerViewProductPageState extends State<CustomerViewProductPage> {
  ...
  void _navigateToOrderPage(String name, String price, String? image) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => CustomerOrderProductPage(
          productName: name,
          productPrice: price,
          productImage: image,
        ),
                    ...
                    return GridView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return GestureDetector(
                          onTap: () {
                            _navigateToOrderPage(item.goodsName, item.goodsPrice, item.goodsImage);
                          },
                          child: Container(
                            decoration: BoxDecoration(
