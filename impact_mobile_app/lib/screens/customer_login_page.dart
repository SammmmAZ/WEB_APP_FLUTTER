...
import 'package:farmer_app/screens/customer_choose_location_page.dart';
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => CustomerChooseLocationPage(), // change the entry point to the next page here => customer_set_location_page -- chooses location CAMERON HIGHLANDS, MACHANG or BESUT
                            ),
                          );
                        },
                        child: Text('Submit'),
